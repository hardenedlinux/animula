...
/* NOTE: the full numeric tower (+, -, *, /, =, <, >, <=, >=, and all the
 * exactness/rational machinery behind them) lives in number.c, declared
 * in number.h and pulled in above. This file is VM/primitive-table glue
 * only -- it should not reimplement numeric semantics locally. */
