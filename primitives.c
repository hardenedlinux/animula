...
static void *num_add_op_table[] = {[int_int_add] = (void *)int_int_add,
                                   [real_real_add] = (void *)real_real_add,
                                   [rat_rat_add] = (void *)rational_add,
                                   [rat_int_add] = (void *)rat_int_add};

static void *num_sub_op_table[] = {[int_int_sub] = (void *)int_int_sub,
                                   [real_real_sub] = (void *)real_real_sub,
                                   [rat_rat_sub] = (void *)rational_sub,
                                   [rat_int_sub] = (void *)rat_int_sub};
static void *num_mul_op_table[] = {[int_int_mul] = (void *)int_int_mul,
                                   [real_real_mul] = (void *)real_real_mul,
                                   [rat_rat_mul] = (void *)rational_mul,
                                   [rat_int_mul] = (void *)rat_int_mul};
static void *num_div_op_table[] = {[int_int_div] = (void *)int_int_div,
                                   [real_real_div] = (void *)real_real_div,
                                   [rat_rat_div] = (void *)rational_div,
                                   [rat_int_div] = (void *)rat_int_div};
                               ...
                               imm_object_t y, num_opt_t opn)
{
  switch (y->attr.type)
    ...
    case imm_int:
      {
        int_int_t op = (int_int_t)get_num_op (opn);

        ret->value = (void *)op (x->value, y->value);
...
{
  rational_t r;
  s32_t upper = a.numerator * b.denominator * a.sign
                + b.numerator * a.denominator * b.sign;
  u32_t base = a.denominator * b.denominator;
    ...
    case rational_neg:
      {
        ...
        ret->attr.type = (result.sign) ? rational_neg : rational_pos;
...
static object_t _int_add (vm_t vm, object_t ret, object_t xx, object_t yy)
{
  Object x_ = *xx;
  Object y_ = *yy;
  object_t x = &x_;
                                 ...
                                 object_t yy)
{
  ...
  if (complex_inexact == x->attr.type || complex_inexact == y->attr.type)
           ...
           || (rational_neg == y->attr.type) || (rational_pos == y->attr.type))
    {
      ...
      else // more than 16 bit is used, cannot use as rational, convert to
        // float
        {
