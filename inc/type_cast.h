#ifndef __ANIMULA_TYPE_CAST_H__
#define __ANIMULA_TYPE_CAST_H__
...
void cast_imm_int_to_rational (immu_object_t ret);
void cast_rational_to_imm_int_if_denominator_is_1 (immu_object_t v);
void cast_rational_to_float (immu_object_t v);
