...
#define GC_REGISTER_FINALIZER_NO_ORDER(obj, fn, client_data, ofn, odata) \
  GC_register_finalizer_no_order (obj, fn, client_data, ofn, odata)
  ...
  GC_API void GC_CALL GC_register_finalizer_no_order (
    void GC_NEAR *, GC_finalization_proc, void GC_NEAR *,
    GC_finalization_proc GC_NEAR *, void GC_NEAR *GC_NEAR *);
...
#define GC_UNIMPLEMENTED 3
  ...
  typedef void
    GC_NEAR *(GC_CALLBACK *GC_stack_base_func) (struct GC_stack_base GC_NEAR *,
                                                void GC_NEAR *);
...
#  endif
  ...
  GC_API int GC_CALL
  GC_register_my_thread (CONST struct GC_stack_base GC_NEAR *);
...
#    define GC_INIT_CONF_ROOTS                  \
      (GC_add_roots (GC_DATASTART, GC_DATAEND), \
       GC_add_roots (GC_DATASTART2, GC_DATAEND2))
#  else
